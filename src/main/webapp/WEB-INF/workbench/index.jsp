		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<c:forEach items="${permissions}" var="permission">
					<c:choose>
						<c:when test="${empty permission.permissions}">
							<li class="liClass"><a href="${permission.url}" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> ${permission.pname}</a></li>
						</c:when>
						<c:otherwise>
							<li class="liClass">
								<a href="#no2" class="collapsed" data-toggle="collapse"><span class="glyphicon glyphicon-stats"></span> ${permission.pname}</a>
								<ul id="no2" class="nav nav-pills nav-stacked collapse">
									<c:forEach items="${permission.permissions}" var="son">
										<li class="liClass"><a href="${son.url}" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> ${son.pname}</a></li>
				...
				<li class="liClass">
					...
					<ul id="no2" class="nav nav-pills nav-stacked collapse">
						<li class="liClass"><a href="/crm/toView/workbench/chart/activity/index" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 市场活动统计图表</a></li>
