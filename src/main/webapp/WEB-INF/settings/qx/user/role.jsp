...
<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;left: 30px; width: 110%; top: 20px;">
	<div class="btn-group" style="position: relative; top: 18%;">
		...
		<button type="button" class="btn btn-success"><span class="glyphicon glyphicon-minus"></span> 授权</button>
	</div>
...
<div style="position: relative; left: 30px; top: 40px; width: 110%">
	<table class="table table-hover">
		...
		<tr class="active">
			<td><input type="checkbox" /></td>
			<td>1</td>
			<td><a  href="/crm/settings/toPermission?id=bd12708cadfa4b94aa0bb67b588f49a4">bd12708cadfa4b94aa0bb67b588f49a4</a></td>
			<td>管理员</td>
		</tr>
		<tr>
			<td><input type="checkbox" /></td>
			<td>2</td>
			<td><a  href="/crm/settings/toPermission?id=bd12708cadfa4b94aa0bb67b588f49a5">bd12708cadfa4b94aa0bb67b588f49a5</a></td>
			<td>部门经理</td>
		</tr>
		<tr class="active">
			<td><input type="checkbox" /></td>
			<td>3</td>
			<td><a  href="/crm/settings/toPermission?id=bd12708cadfa4b94aa0bb67b588f49a6">bd12708cadfa4b94aa0bb67b588f49a6</a></td>
			<td>项目主管</td>
		</tr>
		<tr>
			<td><input type="checkbox" /></td>
			<td>4</td>
			<td><a  href="/crm/settings/toPermission?id=bd12708cadfa4b94aa0bb67b588f49a7">bd12708cadfa4b94aa0bb67b588f49a7</a></td>
			<td>普通员工</td>
		</tr>
		</tbody>
	</table>
